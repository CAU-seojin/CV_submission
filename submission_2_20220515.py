...
def submission_2_20220515(yaml_path, output_json_path):
    ...
    import sys, os
    sys.path.insert(0, os.path.abspath("./ultralytics_hyper"))
    from models.yolo.model import YOLO
    model = YOLO(f'ultralytics_hyper/cfg/models/hyper-yolo/{model_name}.yaml')
